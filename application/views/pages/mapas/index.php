            ...
            <div class="row row-align">
                ...
                foreach ($regioes as $regiao) {
                    ...
                    <div class="pesquisas col-8 col-sm-5 col-md col-lg-2 col-xl " id="poppins_title" style="margin-right: 30px;" >
                        ...
                        <?php
                        if ((($atuPage['qtd_exibicao'] == 0) || ( $puu['cont_exibicao'] <= $atuPage['qtd_exibicao'] )) && (strlen($atuPage['texto_balao']) > 1)) {
                            ?>
                        ...
                        if (($atuPage['momento_exibicao'] == 1) &&
                                (
                                ($atuPage['qtd_exibicao'] == 0) || ( $puu['cont_exibicao'] <= $atuPage['qtd_exibicao'] )
                                )
                        ) {
                        ...
                        <button type="button" class="button-pesquisas mt-3" id="exo_subtitle" style="width: 100% !important; padding: 10px 20px; min-height: 40px; background: #2C234D; border-radius: 30px; color: #fff;" onclick="javascript:onContinuar(<?php echo $regiao->tipo ?>);">
                            <?php
                            if (
                                    $regiao->tipo == 1 && @$percent[0] >= 100 || $regiao->tipo == 2 && @$percent[1] >= 100 || $regiao->tipo == 3 && @$percent[2] >= 100 || $regiao->tipo == 4 && @$percent[3] >= 100 || $regiao->tipo == 5 && @$percent[4] >= 100
                            ) {
                                ?>
                                Finalizado
                            <?php } ?>
                            ...
                            <?php
                            if (
                                    $regiao->tipo == 1 && @$percent[0] > 0 && @$percent[0] < 100 || $regiao->tipo == 2 && @$percent[1] > 0 && @$percent[1] < 100 || $regiao->tipo == 3 && @$percent[2] > 0 && @$percent[2] < 100 || $regiao->tipo == 4 && @$percent[3] > 0 && @$percent[3] < 100 || $regiao->tipo == 5 && @$percent[4] > 0 && @$percent[4] < 100
                            ) {
                                ?>
                                Continuar
                                <?php
                            } else if (
                                    $regiao->tipo == 1 && @$percent[0] <= 0 || $regiao->tipo == 2 && @$percent[1] <= 0 || $regiao->tipo == 3 && @$percent[2] <= 0 || $regiao->tipo == 4 && @$percent[3] <= 0 || $regiao->tipo == 5 && @$percent[4] <= 0
                            ) {
                                ?>
                                Iniciar
                            <?php } ?>
