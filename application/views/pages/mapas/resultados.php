...
<div class="container content " style="height: 100%!important">
    <div class="container text-left mt-3 pt-5 pb-5">
        <div class="row" id="c-mobile">
            ...
            <div class="card col" id="sombra" style="margin-right: 10px; border-radius: 6px; text-align: center;">
                <div class="card-body">
                    <p style="color: #000; font-size:14px; font-family: Exo, Sans-serif;">Pesquisas Questões Respondidas</p>
                ...
                <div class="col-6" id='graf1_mobile' style="padding-left: 0;">
                    <div class="card col-12" id='sombra' style="border-radius: 6px;">
                        <div class="card-body" style="width: 100%; height: 400px;">
                            <img width="100%" style="width: 100%; height: 100%" src="<?= base_url() ?>/uploads/graphic/<?php echo $grafico->imagem; ?>">
                        </div>
                    </div>
                </div>
            <?php } ?>
