				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-lg-6 mx-auto">
							...
							<form method="post" action="<?= base_url()?>index.php/login/forgot_request">
								...
								<div class="text-center my-4">
									<button type="submit" class="btn" id="exo_subtitle" style="width: 100% !important; padding: 10px 20px; min-height: 40px; background: #2C234D; border-radius: 30px; color: #fff;">Enviar</button>
								</div>
								<hr class="my-4">
